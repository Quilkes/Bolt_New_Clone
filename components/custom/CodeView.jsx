      ...
      <div className="bg-slate-50 w-full border rounded-t-lg">
        <div className="flex items-center flex-wrap shrink-0 bg-slate-100 p-1 w-[140px] gap-3 justify-center rounded-full">
          <h2
            ...
            className={`text-sm cursor-pointer ${activeTab == "code" && "bg-blue-500 text-blue-500 bg-opacity-25 p-1 px-2 rounded-full"}`}
          >
            Code
          </h2>
          ...
          <h2
            ...
            className={`text-sm cursor-pointer ${activeTab == "preview" && "bg-blue-500 text-blue-500 bg-opacity-25 p-1 px-2 rounded-full"}`}
          >
            Preview
          </h2>
        </div>
